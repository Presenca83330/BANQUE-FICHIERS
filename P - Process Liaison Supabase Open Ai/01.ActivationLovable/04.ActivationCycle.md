...
- Tu es un expert en Ia no code et intégration supabese.
  ...
  - Nous travaillons sur la migration de la phase 2, nous avons déjà travaillé et migré des canaux
...
- Mais lis aussi mes ressources
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/00.PresentationGénéraleNBuilder.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/01.AuditSauvegarde.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/02.AuditOnglet1ElementsNewsletter.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/03.AuditOnglet2Configuration.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/04.AuditOnglet3TestEtEnvoi.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/05.AuditBibledeReferences.md

- Lis aussi ces elements préparatoires
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--1.APIBrevoSynthese.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--2.APIBrevoGuide.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--3.APIBrevoTemplateNewsletter.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--4.APIBrevoExplCreaTemplate.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--5.APIBrevoCodeTemplate.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--6.APIBrevoSupabaseStorage.md
    - public/4. ReadMe EtapesAnnonces/04.NewsletterBuilder/.--7.APIBrevoConfigurationObjet.m

- Lis ces informations et je te poserai ma question dans le chat suivant

```
```typescript
# **ETAPE 8 : COMPLETER LA TABLE newsletter_builder**
- En travaillant sur la migration de l'espace Newsletter_Builder
- Je me suis rendu compte que j'avais besoin dans Canal 4 d'enregistrer d'autres informations lors du processus de sauvegarde dans la table newsletter_builder
- J'aurais besoin de récupérer de récupérer des informations saisies par l'utilisateur lors de l'etape 1, première etape qui sert à récupérer les informations et les envoyer ves open ai.
  - J'aurais besoin de sauvegarder dans la table les informations suivantes :
    - Référence -> champs de la table etapes_1to5 "reference"	
    - Exclusivité -> champs de la table etapes_1to5 "exclusivite"	
    - Emplacement -> champs de la table etapes_1to5 "location"	
    - Type de bien -> champs de la table etapes_1to5 "propertyType"	
    - Type de transaction -> champs de la table etapes_1to5 "saleType"	
    - Prix FAI -> champs de la table etapes_1to5 "price"	
    - Loyer HT/HC -> champs de la table etapes_1to5 "rentAmount"	
    - Périodicité -> champs de la table etapes_1to5 "rentPeriodicity"

- On avait récupéré une information de etape 1 dans le canal4 pour la personnalisation du template, mais dans ce cas, la récupération ne concernait pas la modification de la table
  - c'était ici : public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.06.0.Etape6Canal4/08--InjectionAgenceTemplate.md

- Voilà ma question.
    - Peux-tu me faire un audit et me dire comment récupérer ces informations et créer les champs dans la table newsletter_builder
    - toujours en gardant l'esprit multi-tenant et en veillant à bien récupérer les informations de l'annonce newsletter sauvegardée
    - je te rappelle que les tables etapes_1to5 et newsletter_builder sont et doivent rester totalement indépendantes 
...
---
```typescript
# **ETAPE  : NOUS TRAVAILLONS SUR LE PROJET DE MIGRATION CANAL **
- NOus travaillons en 2 phases 
    - 1/ Phase A : Faire la migration localstorage / Supabase
    - 2/ Phase B : Faire la connexion et l'envoi vers Brevo


Je te poserai ma question ensuite
```
...
```typescript
# **ETAPE  : PROJET DE MIGRATION CANAL 4 **
- Nous avons préparé un audit pour se rappeler des process localstorage actuel
    - 

- Comme tu connais tout les directives de migration phase 2
- les enseignement de la migration du canal 1 et du canal 2
...
## -> Relis les directives Générales de migration
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.02.0.Etape6Global/01--1.AuditPhase2.md
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.02.0.Etape6Global/02--1.ReadMeMigrationPhase2.md
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.02.0.Etape6Global/03--1.Nomenclature.md
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.02.0.Etape6Global/04--1.GuideMigrationCanaux.md
...
## -> Relis les codes utilisés lors des migrations des canaux 1 / 2 
MIGRATION CANAL 1
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/01--1.AuditCanal1.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/02--StratégieMigrationCanal1.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/03--CodesCanal1.md
...
- A toi de faire une analyse d expert 
