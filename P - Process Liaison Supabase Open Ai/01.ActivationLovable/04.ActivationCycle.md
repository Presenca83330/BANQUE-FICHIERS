...
- Tu es un expert en Ia no code et intégration supabese.
  ...
  - Nous travaillons sur la migration de la phase 2, nous avons déjà travailler sur 1 canal
...
- J'ai fait un guide de migration à partir de la migration du canal 1
 - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.02.0.Etape6Global/04--1.GuideMigrationCanaux.md

- Il y a également 2 alertes à prendre en compte pour les migrations des canaux
...
```
```typescript
# **ETAPE 6 : MIGRATION CANAL ANNONCE SITE INTERNET - CANAL 1**
---
- Comme je l'ai indiqué nous travaillons canal par canal
  - Nous avons migrer le canal "Copier Annonce Site Internet" dans l'application ou parfois nommé Canal 1
...
- Nous avions prévu une stratégie de migration et nous avons préparé les codes préparatoires
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/02--1.ProjetMigrationCanal1.md
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/03--StratégieMigrationCanal1.md

- Voici les codes que nous avons utilisés
- public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/04--CodesCanal1.md
...
```typescript
# **ETAPE 7 : PROJET DE MIGRATION CANAL 2**
- Nous avons préparé un audit pour se rappeler des process localstorage actuel
...
- les enseignement de la migration du canal 1
...
```
```typescript
# **ETAPE 7 : PROJET DE MIGRATION CANAL Copier / Intéger sur mon Site Internet - CANAL 2**
---
- Comme je l'ai indiqué nous travaillons canal par canal
  - Nous allons travailler sur le  commencer par le canal Copier / Intéger sur mon Site Internet ou parfois nommé Canal 2

- J'aurais besoin que tu me prépare un audit hyper complet comme nous avons fait pour canal 1 
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.03.0.Etape6Canal1/01--1.AuditCanal1.md

- Mais pour ce canal 2 pour bien préparer la migration peux tu me le transferer dans le chat suivant 
