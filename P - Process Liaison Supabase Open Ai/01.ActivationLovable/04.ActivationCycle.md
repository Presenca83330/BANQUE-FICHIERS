...
- Juste après ce message je te donnerai 3 liens :
  - 1 -> vers la présentation détaillées de ma nouvelle stratégie où tu trouveras les infos qui te manquent certainement
  - 1 -> vers mon cahier des charges en vue du codage de ces fichiers correctifs
  - 1 -> vers mon projet de correction des codes actuels pour appliquer ma nouvelle stratégie
...
# **PASSONS A L'ACTION**
Parfait 
- Maintenant tu vas analyser ces 3 documents
  ...
  - Mon projet de codage en vue de remplacer les fichiers actuels
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--3.27.11.CycleCodes.md
- Ta mission est d'analyser ces deux documents et de voir s'ils peuvent etre déployés sans bugs
  - Je te rappelle que ces codes sont destinés à remplacer les les fichiers actuels  pour qu'ils se plient à notre stratégie et non l'inverse
- Si tu as des questions avant de passer à l'action
- N'hésite pas.
---
# **ETAPE 3 / ACTION SUITE MIGRATION CYCLE
- Nous avvions des bugds à répétiitiOn avec notre ancienne structure
- - Après plusieurs correctifs voici les fichiers en place  dans mon application
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/..v1.00.CodesPhase1.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/..v1.01.CodesPhase1.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/..v1.02.CodesPhase1.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/..v1.03.CodesPhase1.md
...
- Compte tenu des ces bugs dans ces anciens fichiers
- j ai décidé
  - Abandon du statut BROUILLON
  - Nouveau mode de calcul des step_progress en 1,2,3,4
  - Prioriser l'utilisation de useStepProgress
    - J ai donc Défini une nouvelle stratégie
      - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--1.27.11.CycleNew.md
    - Défini un cahier des charges
      - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--2.27.11.CycleCahierCharge.md
    - J'ai corrigé les anciens codes que tu as lu précédemment par ceux ci
      - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--3.27.11.CycleCodes.md
    - Nous avons identifié un bug sur les edges
      - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--4.28.11.CycleCorrectifEdge.md
    - Que nous avons corrigé
      - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/15--5.28.11.CycleCorrectifv3.md
- Je viens de faire un test et j'ai été bloqué etape 5 animation et je suis enfin arrivé sur etape6communcaiotn mais les champs sont vides
    - donc effectivement il peut rester d ancien bouts de ode liés aux précédenets procfss
    - ta missooin est de partir de ces connaissance précises de mon historique
    - pour identifier les causes sans se jeter sur la premiere impression venue ok
    - tu dois faire un travail d expert
