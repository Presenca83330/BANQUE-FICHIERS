...
- Bonjour expert Ia, no code, intégration supabase
  ...
  - Je vais te donner mes ressources et infos en 3 étapes :
    - ETAPE 1 -> Comprendre et Analyser tout ce qui fonctionnait à merveille en localstorage
    - ETAPE 2 -> Comprendre ce qui avait été prévu avant de coder
    - ETAPE 3 -> L'état actuel et ma question d'aujourd'hui
---
