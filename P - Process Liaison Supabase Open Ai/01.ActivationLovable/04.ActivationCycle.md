...
```
```typescript
# **ETAPE 6 : MIGRATION CANAL 1/2/3**
---
- Comme je l'ai indiqué nous travaillons canal par canal
- Nous avons migré les canaux : 
- "Copier Annonce Site Internet" dans l'application ou parfois nommé Canal 1"
- "Copier / Intéger sur mon Site Internet ou parfois nommé Canal 2"
- "Copier / Publier sur mes Portails Immobiliers"
...
```typescript
# **ETAPE 7 : NOUS TRAVAILLONS SUR LE PROJET DE MIGRATION CANAL5 **
...
- La Phase A est finalisée et fonctionne
- NOus sommes sur la phase B
  - Lis ces fichiers 
    ...
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.07.0.Etape6Canal5/04--1_StrategiePhaseBCanal5-CORRIGE.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.07.0.Etape6Canal5/04--2_CodesPhaseBCanal5-CORRIGE.md
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/.07.0.Etape6Canal5/04--3_RécapPhaseBCanal5-CORRIGE.md
...
```typescript
# **ETAPE 7 : PROJET DE MIGRATION CANAL 4 **
