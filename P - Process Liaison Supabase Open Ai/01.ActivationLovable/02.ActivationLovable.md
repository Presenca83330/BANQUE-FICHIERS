...
- As-tu des questions ?
- Sinon tu peux lancer ton analyse,
  - A ce stade de l'étude, je ne souhaite pas avoir les codes corrigés si des erreurs existent
  - Je souhaite une présentation claire et synthetique sous forme de tableaux en format md
    - avec les colonnes suivantes :
      - nom de la section
      - numero et nom du code erroné
      - nature de l'erreur
      - emplacement de l'erreur
      - explication de l'erreur
    - solution à apporter (formulation succinte, non développée)
