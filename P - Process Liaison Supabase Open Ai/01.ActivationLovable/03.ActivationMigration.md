...
- Dernièrement tu avais fait ces audits
...
- Ensuite on a travaiillé sur mon projet de cycle utilisateur qui n avait pas été respecté
- tu as fait un projet mais on a conservé celui de claude
...
- Le cycle de vie des projets dans `etapes_1to5` suit 3 états :
...
- Claude a fait ce projet de migration avec ces codes
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/17--ProjClaude
- Nous avons corrigé les fichiers
- Mais nous avons encore identifié des erreurs et claude a fait ce nouveau correctif
    - public/4. ReadMe EtapesAnnonces/03.PreparationMigration/01.Etape1to5/1.Correct.13points
- Mais il y a encore des pbls
