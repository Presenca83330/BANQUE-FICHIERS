...
utilisé pour public/4. ReadMe EtapesAnnonces/02.Etape6Communication/01.SiteInternetAnnonces.md
et adapté au canal 
MISSION DU DOCUMENT
SOMMAIRE CLIQUABLE avec liens hyer texte

I ARCHITECTURE GLOBALE - CANAL 
3.1. Vue d'ensemble du canal 
3.2. Position dans Étape 6 Communication 
3.3. Schéma Mermaid complet (flux de données)

II LISTE EXHAUSTIVE DES FICHIERS UTILISÉS 
...
IV PROCESSUS DE RÉCUPÉRATION DES DONNÉES OPENAI 
...
V  STRUCTURE DES DONNÉES localStorage 
7.1. Clés LUES  
7.2. Clés ÉCRITES 
7.3. Interfaces TypeScript complètes 
7.4. Tableaux récapitulatifs

VI PROCESSUS COMPLET ÉTAPE PAR ÉTAPE 
...
VII SYSTÈME D'ÉDITION - BOUTON "MODIFIER" 
9.1. Localisation  
...
XIII DONNÉES À PRENDRE EN CONSIDÉRATION
