...
Voici la version corrigé du mardi 23 septembre
...
export interface ReseauFormData {
  ...
  // Champs Téléphone / Email → point de vérité = reseau
        ...
        if (kind === 'zoho') {
          ...
          if (data.zoho_connexion_id) {
            const { error } = await supabase
              .from('zoho_connexion')
              .update({
                zoho_api_key: data.zoho_api_key ?? null,
...
const FormReseauGestion: React.FC<Props> = ({ onBack }) => {
  ...
  const handleSaveGeneral = async () => {
    ...
    const success = await saveReseau({
      ...
      direction_telephone: formData.direction_telephone,
      direction_email: formData.direction_email,
    });
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e => updateFormField('direction_telephone', e.target.value)}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={e => updateFormField('direction_email', e.target.value)}
  ...
  try {
    ...
    const { error: reseauError } = await supabase
      ...
      .update({
        ...
        reseau_ressources: generalData.reseau_ressources ?? [],
    ...
    // ============================
    // 2. Synchronisation reseau_direction
    // ============================
