...
USING (
  ...
  AND (
    ...
    -- ✅ Utilisateur réseau : accès uniquement à son dossier reseau-{reseau_id}/...
...
-- Exemple stockage :
--   reseau_logo :
--     bucket-table-reseau/reseau-{uuid}/1-logos/logo-principal.png
--   reseau_ressources :
--     [
...
--   -> Chaque utilisateur n’accède qu’à son dossier reseau-{uuid}
