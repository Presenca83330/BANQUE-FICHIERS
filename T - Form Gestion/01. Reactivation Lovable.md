...
- 1. Commence par lire ce fichier il y a toute ma stratégie :
- src/components/ADMIN-PRESENCA/9-CreationComptesUtilisateurs/1-Formulaires/1.Reseau/.v5.Strategie.Formulaire.Gestion.md
- 2. Ensuite, lis toutes les tables que nous utilisons : src/components/ADMIN-PRESENCA/9-CreationComptesUtilisateurs/1-Formulaires/1.Reseau/.v5.TablesReferenceReseau.ts
- 3. Ensuite, lis les fichiers qui composent notre formulaire avec tous les codes et toutes les routes : src/components/ADMIN-PRESENCA/9-CreationComptesUtilisateurs/1-Formulaires/1.Reseau/.v5.3.Projet.Implantation.Form.Gestion.md
...
- Le selector de réseau ne fonctionne pas, peux tu analyser pourquoi?
---
