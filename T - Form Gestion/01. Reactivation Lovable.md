...
- Je vais te poser une question très précise dans le mail suivant
---
## 5. Ce que tu vas faire
- Nous avons besoin de bien connaitre maintenant le maping des tables utilisées dans le formulaire Agence Independante
- Tables : users, utilisateurs, organisation, agence indépendante, brevo, zoho, open ai, facebook, instagram, linkedin
- Analyse cette table référence : public/3. ReadMe FormPresenca/01.FormReseau/1.FormCreateur/.TablesReferenceReseau.ts
- Je veux que tu fasses exactement la même chose pour préparer le formulaire Agence Indépendante
- J'ai conçu ce fichier vide : src/components/ADMIN-PRESENCA/9-CreationComptesUtilisateurs/1-Formulaires/6.AgenceIndependante/.TablesReferenceAgenceIndependante.ts
- Pourque tu fasses exactement la meme chose pour préparer le formulaire Agence Independante : tes informations doivent être précises completes et exhaustives
---
