...
---
# 5/ Explication du process correctif
- Nous avons travaillé hier sur un nouveau projet,
- Je veux faire exactement la meme chose que public/3. ReadMe FormPresenca/00.BibleGenerationFormTables/02.TemplateFormCreation.md mais pour le formulaire de gestion
- Je veux expliquer un par un tous les fichiers
...
- Je veux faire comme pour le formulaire de création, faire une fiche explication décrivant la conception de chaque fichier avec :
  - Le code sources en 1er,
  - Ensuite, préciser, l'objectif, la directive, en expliquant ce qu'il faut conserver, en expliquant ce qu'il faut adapter en fonction des tables
  ...
  - J'ai fait une structure explicative  par sous etape descriptive
  - Objectif
  - Directives
  - Présentation du code source
- J'ai essayé d'indiquer clairement CONSERVER quand il faut juste copier/coller, il est inutile de rentrer dans des explications
- J'ai essayé de donner des explications claires pour pouvoir développer les formulaires des autres tables en essayant de copier et colonner au maximum la structure qui fonctionne pour la table réseau
- J'ai également tenté de donner les codes sources des parties des fichiers en transmettant toujours le code source de table réseau et de seulement mentionner les endroits à personnaliser sous la forme // ← À PERSONNALISER
- Je voudrais que tu analyses ce que nous avons hier et si la présentation des explications est correcte
- tu peux regarder une dernière fois, ce que nous avons fait pour le formulaire de création
	- public/3. ReadMe FormPresenca/00.BibleGenerationFormTables/02.TemplateFormCreation.md
- et voici le lien vers ce que nous avons fait hier pour le formulaire de gestion, c 'est ici
