...
- Concevoir tous les fichiers du formulaire de gestion
- J'ai préparé un fichier pour nous permettre de créer un par un tous les fichiers préparatoires au formulaire de gestion
...
- Il faut impérativement appliquer et personnalisér les codes prévus et qui fonctionnent pour réseau sans aucune modification
- Il va toutefois y avoir qq modifications
	- 1ere modification :
	...
	- 2ème modification
		- il a des champs informations générales, les champs, titres, préholders ont été définis par admin_presenca et ne doivent pas être modifiés
	...
	- 3ème modification
		...
		- POur la table Agence Indépendante, il y en  aura 6(Zoho, Open Ai, Brevo, Linkedin, Facebook, Instagram)
		- Pour ces nouvelles intégrations il faudra faire exactement la meme chose que pour Zoho, open ai et Brevo sans apporter de mofication et d'optimation
		- Il faudra simplement personnaliser les intégrations
  		- Et Faire attention car des fichiers devront être adaptés à ces nouvelles intégrations comme : Etapte 1/5/8/11 par exemple
	- 4ème modification
		...
		- POur ces fichiers préparatoires, il faudra conserver la fonction prévue dans le graphisme pour accéder à l'onglet Abonnement et laisser les champs actuels inactifs cad sans liens avec supabase, nous ferons ça dans un second temps.
- Est-ce clair?
- Nous fonctionneront fichier par fichier
- Tu me donneras le code complet un par un
- Est-ce clair ?
---
## 7/ Conception
- Tu vas me donner dans le chat suivant
- le code complet de
- Etape
	- Applique impérativement les directives prévues dans public/3. ReadMe FormPresenca/00.BibleGenerationFormTables/03.TemplateFormGestion.md
	- Respecte impérativement les tables actuelles dans Supabase
	...
	- Interdiction totale d'optimiser ou d'améliorer le code de la table réseau qui fonctionne parfaitemen,t
	- Veille à regarder si le fichier doit être personnaliser pour permettre les nouvelles intégrations (Linkedin, Facebook, Instagram) en respectant le maping et le nomming actuel dans supabase et src/components/ADMIN-PRESENCA/9-CreationComptesUtilisateurs/1-Formulaires/6.AgenceIndependante/.01.TablesReferenceAgenceIndependante.ts
	- 
- A toi
---
---
