...
- Nous avons donc travaillé sur la conception d'une bible qui nous permette de reproduire simplement les 2 parties de la structure du formulaire reseau : la partie creation et la partie gestion
...
- On a travaillé hier sur le fichier src/components/HOOKS-STRATEGIQUE/5.HOOKS-CreationCompteAdminPresenca/1.Reseau/types.ts
- Analye-le, comment nous avons défini son utilisation pour concevoir le futur types.ts de la nouvelle table
- Comprends-tu le process et ce que nous allons faire ensemble?
---
