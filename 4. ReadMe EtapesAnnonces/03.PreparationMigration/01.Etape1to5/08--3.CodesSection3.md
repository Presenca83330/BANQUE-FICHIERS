...
export function useStepProgress(currentStep: number = 1): UseStepProgressReturn {
  ...
  // Obtenir les étapes désactivées
  const getDisabledSteps = useCallback(() => {
...
```typescript
import { Etape1Data } from "./01.Etape1/types";
import { Etape2Data } from "./02.Etape2/types";
import { Etape3Data } from "./03.Etape3/types";
import { Etape4Data } from "./04.Etape4/types";
import { Etape5Data } from "./05.Etape5/types";

export interface BaseEtapeData {
  project_id?: string;
...
```typescript
export * from "./00.Technique/useStepProgress";
export * from "./01.Etape1/HookEtape-1";
export * from "./01.Etape1/types";
export * from "./02.Etape2/HookEtape-2";
export * from "./02.Etape2/types";
export * from "./03.Etape3/HookEtape-3";
export * from "./03.Etape3/types";
export * from "./04.Etape4/HookEtape-4";
export * from "./04.Etape4/types";
export * from "./05.Etape5/HookEtape-5";
export * from "./05.Etape5/types";
export * from "./types";
```

---

# N14 : HelpersEtapes1to5.ts
## src/components/HOOKS-ANNONCES/01.HOOKS-ETAPE1TO5/02.Components/HelpersEtapes1to5.ts

```typescript
// Ce fichier est conservé pour compatibilité mais les validations
// sont maintenant dans les fichiers dédiés de la section 2 (Utilitaires)

export { validateEtape1 } from "../03.Utilitaires/validateEtape1";
export { validateEtape2 } from "../03.Utilitaires/validateEtape2";
export { validateEtape3 } from "../03.Utilitaires/validateEtape3";
export { validateEtape4 } from "../03.Utilitaires/validateEtape4";
```
...
interface NavigationEtapesProps {
  currentStep: number;
  availableSteps: number[];
  totalSteps?: number;
}

export const NavigationEtapes: React.FC<NavigationEtapesProps> = ({
  currentStep,
  availableSteps,
  totalSteps = 5
}) => {
  ...
  const canGoNext = currentStep < totalSteps && availableSteps.includes(currentStep + 1);

  const handlePrevious = () => {
    if (canGoPrevious) {
      navigate(`/etape${currentStep - 1}`);
    }
  };
  ...
  return (
    <div className="flex justify-center items-center gap-2 py-4">
      {Array.from({ length: totalSteps }, (_, i) => i + 1).map((step) => {
        const isCompleted = stepProgress.includes(step);
...
# N17 : LayoutGenerationAnnonce.tsx
## src/components/HOOKS-ANNONCES/01.HOOKS-ETAPE1TO5/02.Components/LayoutGenerationAnnonce.tsx

```tsx
import React from "react";
import { ProgressIndicator } from "./ProgressIndicator";
import { NavigationEtapes } from "./NavigationEtapes";

interface LayoutGenerationAnnonceProps {
...
export const LayoutGenerationAnnonce: React.FC<LayoutGenerationAnnonceProps> = ({
  children,
  stepProgress,
  currentStep,
  totalSteps = 5
