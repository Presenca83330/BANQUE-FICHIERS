# DIRECTIVES : Codage SECTION 3
---

# DIRECTIVE 1 : Contenu de la Mission
- Générer l'intégralitgé des codes des hooks prévus dans
...
---
# DIRECTIVE 2 : Fichiers à générer 
- Tous les fichiers hooks seront situés dans :
  - src/components/HOOKS-ANNONCES/01.HOOKS-ETAPE1TO5/01.Hooks/
- Tous les fichiers components seront situés dans :
...
- Les codes complets dnas le message suivants au format md
...
- Chaque élément est présenté de la manière suivante
    - # N1 : Fonction (Utilitaire, Hook, Composant) - Nom 
    - ## lien de l'Emplacement prévu
    - le code complet encapsulé
- Exemple
    - # N1 : Hooks : useStepProgress.ts
    - ##  src/components/HOOKS-ANNONCES/01.HOOKS-ETAPE1TO5/01.Hooks/00.Technique/useStepProgress.ts
    -  ```typescript
        / code ici
       ```
...
# DIRECTIVCES FINALES
## DIRECTIVE FINALE IMPERATIVE ET NON NEGOCIABLE 
- Après validation de l’utilisateur et/ou envoie par l'utilisatuer de la directive,
- l’assistant exécute immédiatement et impérativement l’action sans poser de question complémentaire.

## DIRECTIVE IMPERATIVE ET NON NEGOCIABLE
- L’assistant, disposant de l’ensemble des capacités techniques nécessaires :
...
- Exécute directement chaque instruction de l’utilisateur sans poser de questions supplémentaires, sans signaler les actions entreprises et sans interrompre ou bloquer le processus de restitution.

## DIRECTIVE IMPERATIVE CONCERNANT LA LECTURE DES FICHIERS ZIP
- L'utilisateur autorise expressement l'assitant d'utiliser toutes les techniques y compris Python pour décompresser les dossiers zip versés en ressources
- Afin de lire, analyser, utiliser les informations dans son codage et d'appliquer strictement les directives préparatoires
---
