...
- Il faudra impérativement conserver le graphisme existant
...
- et dans le fichier ZIP qu'il faudra décompresser : Agence_Independante_UseTables.zip
...
Respecter le naming exact des tables utilisées dans le formulaire Agence Indéoendante et la structure EF du modèle `reseau`.
