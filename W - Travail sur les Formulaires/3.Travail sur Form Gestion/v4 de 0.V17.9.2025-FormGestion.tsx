                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => updateFormField('reseau_brevo_connexion_id', e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => updateFormField('reseau_zoho_connexion_id', e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Input 
                      ...
                      onChange={(e) => updateFormField('reseau_openai_connexion_id', e.target.value)}
