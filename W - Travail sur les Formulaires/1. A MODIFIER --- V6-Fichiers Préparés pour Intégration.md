  ...
  const handleFileUpload = async (file: File, type: 'logo' | 'document') => {
    ...
    try {
      const payload = {
        ...
        type,
        filename: file.name,
        content: Array.from(new Uint8Array(await file.arrayBuffer())), // binaire → tableau
      };
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Champ issu de ReseauDirection. Modifiable uniquement dans le formulaire ReseauDirection.
                    </p>
                  </div>
                  <div className="relative">
